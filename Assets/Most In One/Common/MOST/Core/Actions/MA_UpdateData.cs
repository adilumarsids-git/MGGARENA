...
namespace Solo.MOST_IN_ONE
{
    ...
    public class MOSTAction_UpdateData : MOST_ActionCore
    {
        ...
        public enum NumOpreation { Set, Add, Subtract, Multiply, divide, Increment, Decrment }
        ...
        [HideIfAny(nameof(DataType), MOST_Database.DataTypes.Int, false)] // show ONLY when IsInt == true
        ...
        [HideIfAny(nameof(DataType), MOST_Database.DataTypes.Float, false)] // show ONLY when IsInt == true
        ...
        [HideIfAny(nameof(DataType), MOST_Database.DataTypes.Bool, false)] // show ONLY when IsInt == true
        ...
        [HideIfAny(nameof(DataType), MOST_Database.DataTypes.String, false)] // show ONLY when IsInt == true
