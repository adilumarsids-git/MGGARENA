...
namespace Solo.MOST_IN_ONE
{
    ...
    public class ThreeRoadsController : MonoBehaviour
    {
        ...
        // =========================================================
        // Input (button-like: release in same region)
        // =========================================================
        ...
        void HandlePointerInput()
        {
            ...
            {
                int region = MapScreenXToRegionIndex(Input.mousePosition.x, n);
                _mouseDownRegion = region;
            }
            if (Input.GetMouseButtonUp(0) && _mouseDownRegion.HasValue)
            {
                int upRegion = MapScreenXToRegionIndex(Input.mousePosition.x, n);
